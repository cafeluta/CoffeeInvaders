...
public:
    ...
    virtual void draw(SpriteRenderer &renderer, float breakAmount = 0.0f, float customRotation = 0.0f);  // virtual void so we can override this function in other classes
};
